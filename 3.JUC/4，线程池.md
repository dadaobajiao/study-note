...
* 当一个节点入队：
  ...
  //刚开始last head都指向一个节点。后面last向后移动
  ```
...
* handler：拒绝策略，线程到达最大线程数仍有新任务时会执行拒绝策略
  ...
  * ![image-20220118191952409](C:\Users\打倒芭蕉\AppData\Roaming\Typora\typora-user-images\image-20220118191952409.png)

工作原理：

![](https://gitee.com/seazean/images/raw/master/Java/JUC-线程池工作原理.png)

1. 创建线程池，这时没有创建线程（**懒惰**），等待提交过来的任务请求，调用 execute 方法才会创建线程![]![image-20220118191403690](C:\Users\打倒芭蕉\AppData\Roaming\Typora\typora-user-images\image-20220118191403690.png)
...
![image-20220118190317806](C:\Users\打倒芭蕉\AppData\Roaming\Typora\typora-user-images\image-20220118190317806.png)
...
![image-20220118202139761](C:\Users\打倒芭蕉\AppData\Roaming\Typora\typora-user-images\image-20220118202139761.png)
...
执行任务，**但是没有返回值，没办法获取任务执行结果**，出现异常会直接抛出任务执行时的异常。根据线程池中的线程数，选择添加任务时的处理方式
...
![image-20220118120359062](C:\Users\打倒芭蕉\AppData\Roaming\Typora\typora-user-images\image-20220118120359062.png)

### 任务调度

#### 1，Timer

Timer 实现定时功能，Timer 的优点在于简单易用，但由于所有任务都是由同一个线程来调度，因此所有任务都**是串行执行的**，同一时间只能有一个任务在执行，前一个任务的延迟或异常都将会影响到之后的任务

```java
private static void method1() {  //public abstract class TimerTask implements Runnable 
...
![image-20220118202327365](C:\Users\打倒芭蕉\AppData\Roaming\Typora\typora-user-images\image-20220118202327365.png)
...
![image-20220118202925741](C:\Users\打倒芭蕉\AppData\Roaming\Typora\typora-user-images\image-20220118202925741.png)

#### 和连接池不同点

![image-20220118202640582](C:\Users\打倒芭蕉\AppData\Roaming\Typora\typora-user-images\image-20220118202640582.png)
